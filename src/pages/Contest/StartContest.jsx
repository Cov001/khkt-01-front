    ...
    const getData = async () => {
      try {
        ...
        if (response.data.status === 200) {
          ...
          return toast.warning(contestData);
        }
      } catch (error) {
        dispatch({
          type: "SET_SCREEN_LOADING",
  ...
  const submitResult = async () => {
    try {
      ...
      if (data.data.status === 200) {
        ...
        return toast.success("Submit result success!!");
      }
